...
const PublisherList = () => {
    ...
    const { loading: loadingPublishers, execute: fetchPublishers } = useApi(
    ...
    const handleToggleState = async (id) => {
        try {
            ...
            setPublishers(publishers.map(publisher => 
                publisher.id === id ? updatedPublisher : publisher
            ));
        } catch (error) {
            // Error is handled by useApi hook
        }
        ...
        <div className="container mx-auto">
            ...
            {loadingPublishers ? (
                ...
                <div className="bg-gray-50 rounded-lg p-8 text-center">
                    <p className="text-gray-600 mb-4">No hay editoriales registradas</p>
                    <Button 
                        onClick={() => navigate('/publishers/new')}
                        className="bg-primary-600 hover:bg-primary-700"
                    >
